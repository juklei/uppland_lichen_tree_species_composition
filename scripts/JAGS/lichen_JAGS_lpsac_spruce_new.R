...
model{
  ...
  for(m in 1:length(spruce_pred)){
    r_spruce[m] <- r_alpha + r_beta_spruce*spruce_pred[m] + r_beta2_spruce*spruce_pred[m]^2
    log(s_spruce[m]) <- s_alpha + s_beta_spruce*spruce_pred[m] + s_beta2_spruce*spruce_pred[m]^2
  }
